...
void Tiggo_OnYandexManeuver(CTiggoEngine* pEngine, int nType, int nDistanceMeters,
                           const char* pcTitle, const char* pcSubtitle);
void Tiggo_OnYandexRoute(CTiggoEngine* pEngine, const double* pdRoutePoints, 
                        int nPointCount, int nDistanceMeters, int nTimeSeconds);
void Tiggo_OnYandexLocation(CTiggoEngine* pEngine, double dLatitude, double dLongitude,
                           float fBearing, const char* pcRoadName);
